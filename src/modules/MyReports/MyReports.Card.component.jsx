        ...
        <Accordion.Item className="p-0" eventKey={index}>
            <Accordion.Header>
                ...
                <div className="row w-100">
                    ...
                    <div className="col-1 ms-1"><img alt="smile" className="smile-icon" src={imgArray[reportData.reportData.moraleValueId]}/></div>
                    <div className="col-1 ms-2"><img alt="smile"  className="smile-icon" src={imgArray[reportData.reportData.stressValueId]}/></div>
                    <div className="col-1 ms-3"><img alt="smile"  className="smile-icon" src={imgArray[reportData.reportData.workloadValueId]}/></div>
                </div>
                :
                <div className="row w-100">
                    ...
                    <div className="col-1 ms-2 pt-1"><img alt="smile" className="smile-icon" src={imgArray[reportData.reportData.moraleValueId]}/></div>
                    <div className="col-1 ms-2 pt-1"><img alt="smile"  className="smile-icon" src={imgArray[reportData.reportData.stressValueId]}/></div>
                    <div className="col-1 ms-3 pt-1"><img alt="smile"  className="smile-icon" src={imgArray[reportData.reportData.workloadValueId]}/></div>
                </div>
                }
            </Accordion.Header>
            <Accordion.Body className="text-start">
                <div className="param d-flex align-items-start mb-2">
                    <div className="button-wrapper mr-3">
                        ...
                        <button className={"param-button button-"+titleArray[reportData.reportData.moraleValueId]+" btn text-left"} type="button">MORALE</button>
                    </div>
                    <div className="comment ms-4"><i className="text-secondary">{reportData.reportData.moraleComment}</i></div>
                </div>
                <div className="param d-flex align-items-start mb-2">
                    <div className="button-wrapper mr-3">
                        <img className="smile-icon" src={imgArray[reportData.reportData.stressValueId]} alt="smile morale" />
                        <button className={"param-button button-"+titleArray[reportData.reportData.stressValueId]+" btn text-left"} type="button">STRESS</button>
                    </div>
                    <div className="comment ms-4"><i className="text-secondary">{reportData.reportData.stressComment}</i></div>
                </div>
                <div className="param d-flex align-items-start mb-2">
                    <div className="button-wrapper mr-3">
                        <img className="smile-icon" src={imgArray[reportData.reportData.workloadValueId]} alt="smile morale" />
                        <button className={"param-button button-"+titleArray[reportData.reportData.workloadValueId]+" btn text-left"} type="button">WORKLOAD</button>
                    </div>
                    <div className="comment ms-4"><i className="text-secondary">{reportData.reportData.workloadComment}</i></div>
                </div>
...
export const MyReportsCard = (reportData, key) => {
    return(
        <Accordion className="shadow-sm rounded mt-2 bg-white" defaultActiveKey="0">
            {reportData.reportData.dateTo ? <FilledCard reportData={reportData.reportData} index ={key}/> : 
            <NotFilledCard reportData={reportData.reportData}/>}
        </Accordion>
    )
}
