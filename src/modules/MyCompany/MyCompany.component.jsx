                ...
                <div className="col-md-12 p-0">
                    ...
                    <div className="page-section">
                        ...
                        <form className="col-md-4">
                            ...
                            <div className="form-group">
                                <button type="submit" className="btn btn-outline-dark border-2 shadow-none">
                                    Save name change
                                </button>
                            </div>
                        </form>
                    ...
                    <div className="page-section">
                        ...
                        <p className="page-text">
                            If you need to edit a particular team member, you can see a complete list of team members and visit theit profile to make edits. <strong>You will not be able to see a team member's weekly report.</strong>
                        </p>
