            ...
            <div className="modal1">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="tags">
                            {!deleteMember && teamMemberStore.map((item, index) => (
                        ...
                        <form>
                            {!insertedMember && (
                                <select id="selectObj" className="form-select mb-3" aria-label="Default select example" onChange={insertMember}>
                                    {title === "Edit Leader(s)" ? <option value={0}>Select company members to whom you will send reports.</option>
                                    : <option value={0}>Select company members who will send you reports.</option>}
                                    {uniqueMembers.map((item,index) => (
                                        <option key={index} value={item[0]}>{item[1] + " " + item[2]}</option>
                                    ))}
                                </select>
                            )}
